    ...
    <div className="space-y-6">
      ...
      >
        <button
          ...
          className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-primary to-primary-dark text-white py-3 px-4 rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-primary/30 disabled:opacity-50"
        >
          {isSearching ? (
            <>
              <motion.div
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 relative">
        ...
        {isMobile && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-50 bg-gradient-to-r from-primary to-primary-dark text-white p-4 rounded-full shadow-xl hover:shadow-2xl transition-all"
