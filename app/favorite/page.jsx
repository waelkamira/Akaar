...
export default function Favorites() {
  ...
  const fetchFavorites = useCallback(async () => {
    try {
      ...
      const response = await fetch(
        `/api/favorite?userId=${userId}&page=${page}&limit=8`,
        {
      ...
      if (json.favorites) {
        setFavorites((prev) =>
          page === 0 ? json.favorites : [...prev, ...json.favorites]
        );
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full sm:my-8 mt-16 sm:mt-0">
      <div className="flex flex-col w-full xl:w-[90%] 2xl:w-[80%] px-2 sm:px-16 pt-2 overflow-y-auto">
        <div className="flex items-center justify-between bg-white p-4 rounded-lg shadow-sm my-8">
