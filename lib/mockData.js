export const products = [
  {
    ...
    deletedAt: null,
    description: "سيارة هوندا مستعملة بحالة ممتازة، موديل 2020، ماشية 50 ألف كم فقط. صيانة دورية في الوكالة.", // Used Honda car in excellent condition, 2020 model, only 50k km. Regular maintenance at the dealership.
    details: {
      year: "10",
      brand: "4",
  ...
  },
  {
    ...
    deletedAt: null,
    description: "هاتف آيفون 16 برو جديد مع ضمان لمدة سنة، ذاكرة 256 جيجابايت، لون أسود، مع جميع الملحقات الأصلية.", // New iPhone 16 Pro with 1-year warranty, 256GB storage, black color, with all original accessories.
    details: {
      brand: "1", // Apple
      model: "iPhone 16 Pro",
      storage: "256",
  ...
  },
  {
    ...
    deletedAt: null,
    description: "شقة للبيع في منطقة الإنشاءات، 2 غرفة نوم، حمام، صالة، مطبخ، بلكون، الطابق الثالث، تشطيبات جيدة.", // Apartment for sale in Al-Inshaat area, 2 bedrooms, 1 bathroom, living room, kitchen, balcony, 3rd floor, good finishes.
    details: {
      area: "120",
      rooms: "2",
      adType: "1",
...
export const filterOptions = {
  ...
  static: {
    city: [
      { id: "دمشق", name: "دمشق" }, // Damascus
      { id: "حلب", name: "حلب" }, // Aleppo
      { id: "حمص", name: "حمص" }, // Homs
      { id: "اللاذقية", name: "اللاذقية" }, // Latakia
    ],
    priceRange: {
      min: 0,
      max: 150000,
