    ...
    <div className="rounded-lg border-t-[20px] border-one bg-white mb-4 w-full">
      ...
      >
        ...
        {showModal && (
          ...
          >
            <div
              className="relative flex flex-col w-full xl:w-3/4 2x:w-1/2 justify-center items-center bg-white sm:p-4 rounded-lg shadow-lg z-50"
              onClick={(e) => e.stopPropagation()}
            >
              <Item {...post} />

              <div className="absolute bottom-0 z-[100] mb-14 w-full px-14 bg-white">
                <Button
                  title={'إغلاق'}
                  style={' '}
                  onClick={() => setShowModal(false)}
