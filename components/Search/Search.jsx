      ...
      <div className="flex flex-col items-center justify-center w-full pb-8">
        <div className="w-full sm:w-2/3 p-2 sm:p-4 bg-white sm:bg-white/90 backdrop-blur-sm rounded-lg shadow-lg flex justify-center items-center gap-2">
          <button
            ...
            className="flex justify-center items-center bg-blue-500 text-white text-nowrap rounded-md h-10 px-4 hover:bg-blue-600 transition-all"
          >
          ...
          <input
            ...
            className="flex-grow text-gray-800 w-full rounded-md h-10 p-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
      </div>
