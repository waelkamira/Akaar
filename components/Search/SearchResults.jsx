      ...
      {hasMore && (
        ...
        >
          <motion.button
            ...
            onClick={loadMore}
            disabled={loading}
            className="relative px-6 py-3 bg-gradient-to-r from-primary to-primary-dark text-white rounded-full shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden"
          >
            {loading && (
              <motion.div
                initial={{ width: 0 }}
