...
const FilterContent = React.memo(
  ({ onSearch, onReset, searchData, setSearchData, category }) => {
    ...
    return (
      <div className="flex flex-col sm:flex-row items-start justify-start bg-primary-500 gap-2 w-full py-2 overflow-x-auto whitespace-nowrap scrollbar-thin scrollbar-thumb-primary-500 scrollbar-track-three 2xl:mr-[203px]">
