...
export default function MainNavbar() {
  ...
  return (
    <div className="relative w-full pb-8 xl:pb-32">
            ...
            <button
              className={`${
                ...
                (isSearchTriggered &&
                  ...
                  ? 'bg-[#EC2D20]'
                  : 'bg-one'
              } flex justify-center items-center sm:text-lg text-sm text-white text-nowrap select-none rounded-[5px] h-[32px] sm:h-[40px] xl:h-[50px] xl:w-[15%] p-2 hover:scale-[101%] transition-transform shadow-md border border-white hover:shadow-lg`}
              onClick={() => {
                if (
                  searchResults?.length > 0 ||
                  totalCount > 0 ||
