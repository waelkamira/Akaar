...
export default function CustomToast({
  ...
  return (
    <div
      ...
      } max-w-md w-full bg-white text-four shadow-sm shadow-gray-300  rounded-[5px] pointer-events-auto flex-2 items-center justify-center p-4 mx-2 border border-one`}
    >
